...
async function main() {
  ...
  console.log("Seeded SourceHub workspace, CRM, service desk, asset, network, employee, attendance, project, finance, knowledge, reporting, automation, AI, mobile, and enterprise readiness data.");
}
