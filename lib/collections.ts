export const collectionNames = {
  ...
  enterpriseIdentityLinks: "enterpriseIdentityLinks",
  enterpriseIdentityHistory: "enterpriseIdentityHistory",
  enterpriseMfaPolicies: "enterpriseMfaPolicies",
  enterpriseMfaFactors: "enterpriseMfaFactors",
  enterpriseSessions: "enterpriseSessions",
  enterpriseProvisioning: "enterpriseProvisioning",
  enterpriseProvisioningHistory: "enterpriseProvisioningHistory",
  offices: "offices",
  officeMemberships: "officeMemberships",
  apiServiceAccounts: "apiServiceAccounts",
  apiCredentials: "apiCredentials",
  apiUsage: "apiUsage",
  apiRateLimits: "apiRateLimits",
  apiAuditEvents: "apiAuditEvents",
  ...
  restoreExecutions: "restoreExecutions",
  disasterRecoveryTests: "disasterRecoveryTests",
  featureFlags: "featureFlags",
  featureFlagHistory: "featureFlagHistory",
  maintenanceWindows: "maintenanceWindows",
  enterpriseAuditEvents: "enterpriseAuditEvents",
  commercialTenants: "commercialTenants",
  tenantMemberships: "tenantMemberships",
  tenantInvitations: "tenantInvitations",
  tenantProvisioningJobs: "tenantProvisioningJobs",
  tenantSettings: "tenantSettings",
  tenantBranding: "tenantBranding",
  tenantDomains: "tenantDomains",
  commercialReadiness: "commercialReadiness",
  commercialPlans: "commercialPlans",
  commercialPlanVersions: "commercialPlanVersions",
  commercialFeatures: "commercialFeatures",
  commercialAddons: "commercialAddons",
  commercialTrials: "commercialTrials",
  commercialSubscriptions: "commercialSubscriptions",
  commercialEntitlements: "commercialEntitlements",
  commercialTenantOverrides: "commercialTenantOverrides",
  commercialBillingCustomers: "commercialBillingCustomers",
  commercialBillingEvents: "commercialBillingEvents",
  commercialBillingActions: "commercialBillingActions",
  commercialInvoices: "commercialInvoices",
  commercialUsageEvents: "commercialUsageEvents",
  commercialUsageDaily: "commercialUsageDaily",
  commercialUsageMonthly: "commercialUsageMonthly",
  commercialUsageQuotas: "commercialUsageQuotas",
  commercialOnboarding: "commercialOnboarding",
  commercialIntegrations: "commercialIntegrations",
  commercialIntegrationInstallations: "commercialIntegrationInstallations",
  commercialIntegrationSecrets: "commercialIntegrationSecrets",
  commercialDataJobs: "commercialDataJobs",
  commercialExports: "commercialExports",
  commercialImports: "commercialImports",
  commercialLifecycleJobs: "commercialLifecycleJobs",
  commercialSupportSessions: "commercialSupportSessions",
