...
const collections = {
  ...
  automationWorkflow: "automationWorkflows",
  automationVersion: "automationVersions",
  automationTrigger: "automationTriggers",
  automationStepExecution: "automationStepExecutions",
  automationApproval: "automationApprovals",
  automationSchedule: "automationSchedules",
  automationIdempotency: "automationIdempotency",
  automationDeadLetter: "automationDeadLetters",
  automationTemplate: "automationTemplates",
  automationWebhookConfig: "automationWebhookConfigs",
  automationWebhookDelivery: "automationWebhookDeliveries",
  automationActivity: "automationActivities",
  ...
  knowledgeRevision: "knowledgeRevisions",
  ...
  knowledgeReview: "knowledgeReviews",
  knowledgeReviewComment: "knowledgeReviewComments",
  knowledgeFeedback: "knowledgeFeedback",
  knowledgeView: "knowledgeViews",
  knowledgeSearchEvent: "knowledgeSearchEvents",
  knowledgeSearchSuggestion: "knowledgeSearchSuggestions",
  knowledgeAttachment: "knowledgeAttachments",
  policyAcknowledgement: "policyAcknowledgements",
  policyAcknowledgementUniqueness: "policyAcknowledgementUniqueness",
  knowledgeImportJob: "knowledgeImportJobs",
  knowledgeActivity: "knowledgeActivities",
  knowledgeSavedView: "knowledgeSavedViews",
  knowledgeLinkCheck: "knowledgeLinkChecks",
  knowledgeJobRun: "knowledgeJobRuns",
  knowledgeTicketLink: "knowledgeTicketLinks",
  knowledgeAssetLink: "knowledgeAssetLinks",
  knowledgeNetworkLink: "knowledgeNetworkLinks",
  knowledgeClientAssignment: "knowledgeClientAssignments",
